                ...
                <div class="col-lg-10">
                    <div class="page-single">
                        <div class="page-img global-img">
                            <img src="{{ asset($program->image) }}" alt="Event Image" class="img-fluid rounded-3">
                        </div>

                        <h3 class="h3 mt-4">About the {{ $program->title }}</h3>
                        <p class="mb-30">
                            {!! $program->content !!}
                        </p>
                        ...
                        @php
                            ...
                            $programName = array_filter(array_map('trim', $programName));
                            
                            // Remove duplicates if any
                            $programName = array_unique($programName);
                            
                            // Reset index
                            $programName = array_values($programName);
                        @endphp

                        @if(!empty($programName) && count($programName) > 0)
                            <div class="course-badges-section">
                                ...
                                <div class="mt-3 pt-2">
                                    <small class="text-muted">
                                        ...
                                        Total Specializations: <strong>{{ count($programName) }}</strong>
                                    </small>
                                </div>
                            </div>
                        @else
