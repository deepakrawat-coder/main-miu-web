        ...
        <div class="container mb-4">
            <div class="row gy-60 justify-content-center">
                <div class="col-xl-9">
                    ...
                    <div
                        class="scholar-content z-index-common ms-xxl-4 ms-xl-2 bg-white p-4 shadow-sm" style="border-radius: 16px">
                        <div class="title-area  text-lg-start mt-3 mb-1">
                            ...
                            <p class="sec-text wow fadeInUp" data-wow-delay=".3s">
                                Being the Chancellor of such a prestigious institution is a great honor. At MIU, we focus on
                                creating an environment where innovation, inclusivity, and excellence guide our actions.
                            </p>
                            <p class="sec-text wow fadeInUp" data-wow-delay=".3s">
                                Our university has a rich history of accomplishments and firm dedication to shaping future
                                leaders. We offer a supportive setting that fosters personal and professional development.
                            ...
                            <p class="sec-text wow fadeInUp" data-wow-delay=".3s">
                                ...
                                opportunities for collaboration, exploration, and progress. You will encounter a community
                                that values creativity, critical thinking, and continuous learning.
                            </p>
                            <p class="sec-text wow fadeInUp" data-wow-delay=".3s">
                                We are dedicated to upholding our legacy of excellence by introducing innovative programs,
                                forging interdisciplinary partnerships, and striving for societal impact.
                            </p>
                            <p class="sec-text wow fadeInUp" data-wow-delay=".3s">
                                Feel free to explore our website to discover more about our programs, research projects, and
                                vibrant campus atmosphere
                            </p>
                            <p class="sec-text wow fadeInUp" data-wow-delay=".3s">
                                We appreciate your interest in Manipur International University. Let's work together towards
                                a brighter future.
                            </p>
                            ...
                            <div class="row align-items-center">
                                <div class="col-8 col-sm-8">
                                    <div class="re mb-2">
                                        <p class="sec-text fw-bold wow fadeInUp mb-0" data-wow-delay=".3s">Best wishes, </p>
                                        <p class="sec-text fw-bold wow fadeInUp mb-0" data-wow-delay=".3s">Dr. Hari kumar
                                        </p>
                                        <p class="sec-text fw-bold wow fadeInUp mb-0" data-wow-delay=".3s">Chancellor </p>
                                    </div>
                                </div>
