                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="about-feature-wrapp row justify-content-center" style="max-width:100%">
                            <div class="about-feature wow fadeInUp col-12 col-sm-12 col-md-12 col-lg-4 col-xxl-4"
                                data-wow-delay=".3s"><span class="box-icon"><img src="assets/img/icon/ab-users.svg"
                                        alt="icon"></span>
                            ...
                            <div class="about-feature wow fadeInUp col-12 col-sm-12 col-md-12 col-lg-4 col-xxl-4"
                                data-wow-delay=".4s"><span class="box-icon"><img src="assets/img/icon/ab-message.svg"
                                        alt="icon"></span>
                                <div class="box-content">
                            ...
                            <div class="about-feature wow fadeInUp col-12 col-sm-12 col-md-12 col-lg-4 col-xxl-4"
                                data-wow-delay=".4s"><span class="box-icon"><img src="assets/img/icon/library.svg"
                                        alt="icon"></span>
                                <div class="box-content">
