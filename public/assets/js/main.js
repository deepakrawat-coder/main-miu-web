!(function (e) {
    ...
    (e("[data-bg-src]").length > 0 &&
        ...
        e(".th-slider").each(function () {
            ...
            (e(".slider-area").length > 0 &&
                ...
                e("[data-slider-prev], [data-slider-next]").on(
                    "click",
                    function () {
                        var t =
                                e(this).data("slider-prev") ||
                                e(this).data("slider-next"),
                            n = e(t);
                        if (n.length) {
                            var a = n[0].swiper;
                            a &&
    ...
    if (
        ...
        (TweenMax.to({}, 0.016, {
            ...
            onRepeat: function () {
                ((A += (q - A) / 9),
                    (L += (B - L) / 9),
                    TweenMax.set(E, { css: { left: A - 12, top: L - 12 } }));
            },
        }),
    ...
    if (
        ...
        gsap.utils.toArray(".gsap-parallax").forEach((e) => {
            ...
            gsap.timeline({
                scrollTrigger: { trigger: e, scrub: !0, pin: !1 },
            }).fromTo(
                t,
